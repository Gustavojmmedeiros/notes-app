...
> Full-stack note-taking application built with a **microservices architecture**, featuring a React frontend, a Node gateway and a Java Spring Boot backend with PostgreSQL.
